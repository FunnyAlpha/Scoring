...
def get_df_vct_blaze(p_type,p_dict):
    ...
    if not df.empty:
        ...
        # print(df)
        column = df[2].unique()
        # print(df.drop(0,1).set_index([1, 2]).unstack().droplevel(0, axis=1).rename_axis(
        #     index=None, columns=None).reindex(column, axis=1).reset_index())
...
test_str = '''
c|applicantData.creditTypePrefered|RD
c|applicantData.isDataChanged|name2,birth_place,sex,name_mother,card_number,published,who_issued,specification,district,zip_code,town,street,street_num,apprt_num,date_registration
n|applicantData.maxValueRd|100000
n|applicantData.maxValueSc|741000
c|applicantData.productRequested|POLZA
c|applicantData.typeProcess|isProcess=>ExtQn_Full;isTypeApplication=>ExtQn;PDN_Process
n|applicantData.cars[0].cuid|51347546
n|applicantData.expense.persons[0].cuid|44003648
n|applicantData.previousApplications.isTwPartnerLimitAvailable|0
d|applicantData.previousApplications.approvalData.lastApprovalDateFullApplication|08.04.2020 12:35:12
d|applicantData.previousApplications.approvalData.lastApprovalDatePos|08.04.2020 12:35:12
...
n|applicantData.previousApplications.persons[0].cntContractActivePos|1
...
n|applicantData.previousApplications.persons[0].cuid|44003648
n|applicantData.previousApplications.persons[0].daysFromPreviousCredit|0
d|applicantData.previousApplications.persons[0].firstADateNotRD|11.10.2015 00:00:00
n|applicantData.previousApplications.persons[0].firstaCreditAmount|38076
d|applicantData.previousApplications.persons[0].firstaDate|11.10.2015 16:54:45
n|applicantData.previousApplications.persons[0].firstaDownpayment|0
n|applicantData.previousApplications.persons[0].firstaPaymentNum|16
n|applicantData.previousApplications.persons[0].lastActiveCreditAmount|38076
d|applicantData.previousApplications.persons[0].lastApplicationDate|08.04.2020 12:34:29
d|applicantData.previousApplications.persons[0].lastApprovalDate|08.04.2020 12:35:12
d|applicantData.previousApplications.persons[0].lastApprovalDateNotRD|08.04.2020 00:00:00
c|applicantData.previousApplications.persons[0].lastApprovedEducation|3
n|applicantData.previousApplications.persons[0].lastApprovedEir|1.422
n|applicantData.previousApplications.persons[0].lastApprovedNotRdGoodsPrice|60170
c|applicantData.previousApplications.persons[0].lastApprovedNotRdGoodsType|MOB
n|applicantData.previousApplications.persons[0].lastApprovedNotRdPaymentNum|36
n|applicantData.previousApplications.persons[0].lastCreditAmount|60170
c|applicantData.previousApplications.persons[0].lastExistingCreditType|SS
d|applicantData.previousApplications.persons[0].lastExistingSSCreditDate|08.04.2020 12:35:12
c|applicantData.previousApplications.persons[0].lastFamilyState|2
n|applicantData.previousApplications.persons[0].lastFlatCnt|1
c|applicantData.previousApplications.persons[0].lastHouseType|3
d|applicantData.previousApplications.persons[0].lastMobilePhoneChangeDate|11.10.2015 16:54:23
n|applicantData.previousApplications.persons[0].lastPaymentNum|36
c|applicantData.previousApplications.persons[0].lastPhone|4746422775
c|applicantData.previousApplications.persons[0].lastSellerplaceName|ООО Svzaynoi
c|applicantData.previousApplications.persons[0].lastStatus|s
...
n|credit.isDesireTw|0
n|credit.isDynamic|0
n|credit.isMultiSelect|0
n|credit.isPosOnCard|0
n|credit.isPseudo|0
n|credit.isTW|0
c|credit.linkedCodeChannel|SS001
c|credit.linkedTo|2335268605
n|credit.lostThingsFeeAmount|0
c|credit.mfo|bank
n|credit.photoExists|0
n|credit.price|0
n|credit.priceNoDiscount|0
...
n|credit.persons[0].cuid|44003648
n|credit.creditBureau.bureauResponse[3].cache_use|1
c|credit.creditBureau.bureauResponse[3].cbId|nbk
n|credit.creditBureau.bureauResponse[3].code|25
n|credit.creditBureau.bureauResponse[4].cache_use|1
c|credit.creditBureau.bureauResponse[4].cbId|equ
n|credit.creditBureau.bureauResponse[4].code|25
n|credit.creditBureau.bureauResponse[5].cache_use|1
c|credit.creditBureau.bureauResponse[5].cbId|equ
n|credit.creditBureau.bureauResponse[5].code|25
n|credit.creditBureau.bureauResponse[6].cache_use|1
c|credit.creditBureau.bureauResponse[6].cbId|exp
n|credit.creditBureau.bureauResponse[6].code|1
n|credit.creditBureau.bureauResponse[7].cache_use|1
...
c|credit.creditBureau.creditData[0].cbOverdueLine|CCCCC000000000000000000000000000-0000000000000000-
...
n|credit.creditBureau.creditData[0].creditCostRate|36.5
c|credit.creditBureau.creditData[0].creditCurrency|rur
d|credit.creditBureau.creditData[0].creditDate|31.03.2016 00:00:00
n|credit.creditBureau.creditData[0].creditDayOverdue|0
d|credit.creditBureau.creditData[0].creditEndDate|31.03.2022 00:00:00
d|credit.creditBureau.creditData[0].creditEndDateFact|17.12.2019 00:00:00
...
n|credit.creditBureau.creditData[0].creditSum|0
...
n|credit.creditBureau.creditData[0].creditType|4
c|credit.creditBureau.creditData[0].creditTypeUni|4
d|credit.creditBureau.creditData[0].creditUpdate|22.12.2019 00:00:00
n|credit.creditBureau.creditData[0].cuid|44003648
...
n|credit.creditBureau.creditData[1].cbAnnuity|0
c|credit.creditBureau.creditData[1].cbId|exp
c|credit.creditBureau.creditData[1].cbOverdueLine|CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
n|credit.creditBureau.creditData[1].creditCostRate|28.68
c|credit.creditBureau.creditData[1].creditCurrency|rur
d|credit.creditBureau.creditData[1].creditDate|25.04.2014 00:00:00
n|credit.creditBureau.creditData[1].creditDayOverdue|0
d|credit.creditBureau.creditData[1].creditEndDate|25.04.2019 00:00:00
d|credit.creditBureau.creditData[1].creditEndDateFact|28.04.2014 00:00:00
...
n|credit.creditBureau.creditData[1].creditSum|314000
...
d|credit.creditBureau.creditData[1].creditUpdate|12.05.2019 00:00:00
n|credit.creditBureau.creditData[1].cuid|44003648
...
n|credit.creditBureau.creditData[2].cbAnnuity|1126
c|credit.creditBureau.creditData[2].cbId|exp
c|credit.creditBureau.creditData[2].cbOverdueLine|00000-00000
...
n|credit.creditBureau.creditData[2].creditCostRate|17.23
c|credit.creditBureau.creditData[2].creditCurrency|rur
d|credit.creditBureau.creditData[2].creditDate|08.05.2019 00:00:00
n|credit.creditBureau.creditData[2].creditDayOverdue|0
d|credit.creditBureau.creditData[2].creditEndDate|08.05.2022 00:00:00
n|credit.creditBureau.creditData[2].creditJoint|0
n|credit.creditBureau.creditData[2].creditMaxOverdue|0
c|credit.creditBureau.creditData[2].creditOwner|0
n|credit.creditBureau.creditData[2].creditProlong|0
n|credit.creditBureau.creditData[2].creditSum|31500
n|credit.creditBureau.creditData[2].creditSumDebt|24314
n|credit.creditBureau.creditData[2].creditSumLimit|0
n|credit.creditBureau.creditData[2].creditSumOverdue|0
...
d|credit.creditBureau.creditData[2].creditUpdate|09.03.2020 00:00:00
n|credit.creditBureau.creditData[2].cuid|44003648
n|credit.creditBureau.creditData[2].delay30|0
n|credit.creditBureau.creditData[2].delay5|0
...
n|credit.creditBureau.creditData[3].cbAnnuity|0
c|credit.creditBureau.creditData[3].cbId|exp
c|credit.creditBureau.creditData[3].cbOverdueLine|CCCCCC0000000000000000000000000000
c|credit.creditBureau.creditData[3].contractSource|cb
n|credit.creditBureau.creditData[3].cred_ratio|0
n|credit.creditBureau.creditData[3].creditActive|0
n|credit.creditBureau.creditData[3].creditCollateral|0
n|credit.creditBureau.creditData[3].creditCostRate|15.92
c|credit.creditBureau.creditData[3].creditCurrency|rur
d|credit.creditBureau.creditData[3].creditDate|13.07.2017 00:00:00
n|credit.creditBureau.creditData[3].creditDayOverdue|0
d|credit.creditBureau.creditData[3].creditEndDate|13.07.2020 00:00:00
d|credit.creditBureau.creditData[3].creditEndDateFact|14.11.2019 00:00:00
n|credit.creditBureau.creditData[3].creditJoint|0
n|credit.creditBureau.creditData[3].creditMaxOverdue|0
c|credit.creditBureau.creditData[3].creditOwner|0
n|credit.creditBureau.creditData[3].creditProlong|0
n|credit.creditBureau.creditData[3].creditSum|88200
n|credit.creditBureau.creditData[3].creditSumDebt|0
n|credit.creditBureau.creditData[3].creditSumLimit|0
n|credit.creditBureau.creditData[3].creditSumOverdue|0
...
d|credit.creditBureau.creditData[3].creditUpdate|20.02.2020 00:00:00
n|credit.creditBureau.creditData[3].cuid|44003648
n|credit.creditBureau.creditData[3].delay30|0
n|credit.creditBureau.creditData[3].delay5|0
...
n|credit.creditBureau.creditData[4].cbAnnuity|0
c|credit.creditBureau.creditData[4].cbId|equ
c|credit.creditBureau.creditData[4].cbOverdueLine|CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC00000000
c|credit.creditBureau.creditData[4].contractSource|vki
n|credit.creditBureau.creditData[4].creditActive|0
c|credit.creditBureau.creditData[4].creditCurrency|rur
d|credit.creditBureau.creditData[4].creditDate|28.12.2013 00:00:00
n|credit.creditBureau.creditData[4].creditDayOverdue|0
d|credit.creditBureau.creditData[4].creditEndDate|02.03.2015 00:00:00
d|credit.creditBureau.creditData[4].creditEndDateFact|02.03.2015 00:00:00
n|credit.creditBureau.creditData[4].creditJoint|0
n|credit.creditBureau.creditData[4].creditMaxOverdue|0
c|credit.creditBureau.creditData[4].creditOwner|0
n|credit.creditBureau.creditData[4].creditSum|22500
n|credit.creditBureau.creditData[4].creditSumDebt|0
n|credit.creditBureau.creditData[4].creditSumOverdue|0
n|credit.creditBureau.creditData[4].creditType|5
c|credit.creditBureau.creditData[4].creditTypeUni|5
d|credit.creditBureau.creditData[4].creditUpdate|03.03.2015 00:00:00
n|credit.creditBureau.creditData[4].cuid|44003648
...
n|credit.creditBureau.creditData[5].cbAnnuity|0
c|credit.creditBureau.creditData[5].cbId|exp
c|credit.creditBureau.creditData[5].cbOverdueLine|CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC--0000-00-00000-
c|credit.creditBureau.creditData[5].contractSource|vki
n|credit.creditBureau.creditData[5].creditActive|0
c|credit.creditBureau.creditData[5].creditCurrency|rur
d|credit.creditBureau.creditData[5].creditDate|28.12.2013 00:00:00
n|credit.creditBureau.creditData[5].creditDayOverdue|0
d|credit.creditBureau.creditData[5].creditEndDate|02.03.2015 00:00:00
d|credit.creditBureau.creditData[5].creditEndDateFact|03.03.2015 00:00:00
n|credit.creditBureau.creditData[5].creditJoint|0
c|credit.creditBureau.creditData[5].creditOwner|0
n|credit.creditBureau.creditData[5].creditSum|22500
...
d|credit.creditBureau.creditData[5].creditUpdate|06.03.2015 00:00:00
n|credit.creditBureau.creditData[5].cuid|44003648
...
c|credit.creditBureau.creditData[6].cbOverdueLine|CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC000000000
c|credit.creditBureau.creditData[6].contractSource|vki
n|credit.creditBureau.creditData[6].creditActive|0
c|credit.creditBureau.creditData[6].creditCurrency|rur
d|credit.creditBureau.creditData[6].creditDate|20.10.2013 00:00:00
n|credit.creditBureau.creditData[6].creditDayOverdue|0
d|credit.creditBureau.creditData[6].creditEndDate|20.06.2014 00:00:00
d|credit.creditBureau.creditData[6].creditEndDateFact|01.06.2014 00:00:00
n|credit.creditBureau.creditData[6].creditJoint|0
c|credit.creditBureau.creditData[6].creditOwner|0
n|credit.creditBureau.creditData[6].creditSum|30332
...
d|credit.creditBureau.creditData[6].creditUpdate|03.07.2014 00:00:00
n|credit.creditBureau.creditData[6].cuid|44003648
...
c|credit.creditBureau.creditData[7].cbId|exp
c|credit.creditBureau.creditData[7].cbOverdueLine|CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC000000000
c|credit.creditBureau.creditData[7].contractSource|vki
n|credit.creditBureau.creditData[7].creditActive|0
c|credit.creditBureau.creditData[7].creditCurrency|rur
d|credit.creditBureau.creditData[7].creditDate|20.10.2013 00:00:00
n|credit.creditBureau.creditData[7].creditDayOverdue|0
d|credit.creditBureau.creditData[7].creditEndDate|20.06.2014 00:00:00
d|credit.creditBureau.creditData[7].creditEndDateFact|20.06.2014 00:00:00
n|credit.creditBureau.creditData[7].creditJoint|0
c|credit.creditBureau.creditData[7].creditOwner|0
n|credit.creditBureau.creditData[7].creditSum|30332
...
d|credit.creditBureau.creditData[7].creditUpdate|02.07.2014 00:00:00
n|credit.creditBureau.creditData[7].cuid|44003648
...
c|credit.creditBureau.creditData[8].cbId|equ
c|credit.creditBureau.creditData[8].cbOverdueLine|CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC00000000
c|credit.creditBureau.creditData[8].contractSource|vki
n|credit.creditBureau.creditData[8].creditActive|0
c|credit.creditBureau.creditData[8].creditCurrency|rur
d|credit.creditBureau.creditData[8].creditDate|20.10.2013 00:00:00
n|credit.creditBureau.creditData[8].creditDayOverdue|0
d|credit.creditBureau.creditData[8].creditEndDate|20.06.2014 00:00:00
d|credit.creditBureau.creditData[8].creditEndDateFact|20.06.2014 00:00:00
...
n|credit.creditBureau.creditData[8].creditSum|30332
n|credit.creditBureau.creditData[8].creditSumDebt|0
n|credit.creditBureau.creditData[8].creditSumOverdue|0
n|credit.creditBureau.creditData[8].creditType|5
c|credit.creditBureau.creditData[8].creditTypeUni|5
d|credit.creditBureau.creditData[8].creditUpdate|22.06.2014 00:00:00
n|credit.creditBureau.creditData[8].cuid|44003648
...
n|credit.creditBureau.creditData[9].cbAnnuity|1126
c|credit.creditBureau.creditData[9].cbOverdueLine|00000-00000
...
n|credit.creditBureau.creditData[9].creditCostRate|17.23
c|credit.creditBureau.creditData[9].creditCurrency|rur
d|credit.creditBureau.creditData[9].creditDate|08.05.2019 00:00:00
n|credit.creditBureau.creditData[9].creditDayOverdue|0
d|credit.creditBureau.creditData[9].creditEndDate|08.05.2022 00:00:00
n|credit.creditBureau.creditData[9].creditJoint|1
...
n|credit.creditBureau.creditData[9].creditSum|31500
n|credit.creditBureau.creditData[9].creditSumDebt|24314
...
d|credit.creditBureau.creditData[9].creditUpdate|09.03.2020 00:00:00
n|credit.creditBureau.creditData[9].cuid|44003648
n|credit.creditBureau.creditData[9].delay30|0
...
n|credit.creditBureau.creditData[10].cbAnnuity|0
c|credit.creditBureau.creditData[10].cbOverdueLine|CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c|credit.creditBureau.creditData[10].contractSource|cb
n|credit.creditBureau.creditData[10].cred_ratio|0
n|credit.creditBureau.creditData[10].creditActive|0
n|credit.creditBureau.creditData[10].creditCollateral|0
n|credit.creditBureau.creditData[10].creditCostRate|28.68
c|credit.creditBureau.creditData[10].creditCurrency|rur
d|credit.creditBureau.creditData[10].creditDate|25.04.2014 00:00:00
n|credit.creditBureau.creditData[10].creditDayOverdue|0
d|credit.creditBureau.creditData[10].creditEndDate|25.04.2019 00:00:00
d|credit.creditBureau.creditData[10].creditEndDateFact|28.04.2014 00:00:00
n|credit.creditBureau.creditData[10].creditJoint|1
n|credit.creditBureau.creditData[10].creditMaxOverdue|0
c|credit.creditBureau.creditData[10].creditOwner|0
n|credit.creditBureau.creditData[10].creditProlong|0
n|credit.creditBureau.creditData[10].creditSum|314000
n|credit.creditBureau.creditData[10].creditSumDebt|0
n|credit.creditBureau.creditData[10].creditSumLimit|0
n|credit.creditBureau.creditData[10].creditSumOverdue|0
...
d|credit.creditBureau.creditData[10].creditUpdate|12.05.2019 00:00:00
n|credit.creditBureau.creditData[10].cuid|44003648
...
n|credit.creditBureau.creditData[11].cbAnnuity|0
c|credit.creditBureau.creditData[11].cbOverdueLine|CCCCCC0000000000000000000000000000
c|credit.creditBureau.creditData[11].contractSource|cb
n|credit.creditBureau.creditData[11].cred_ratio|0
n|credit.creditBureau.creditData[11].creditActive|0
n|credit.creditBureau.creditData[11].creditCollateral|0
n|credit.creditBureau.creditData[11].creditCostRate|15.92
c|credit.creditBureau.creditData[11].creditCurrency|rur
d|credit.creditBureau.creditData[11].creditDate|13.07.2017 00:00:00
n|credit.creditBureau.creditData[11].creditDayOverdue|0
d|credit.creditBureau.creditData[11].creditEndDate|13.07.2020 00:00:00
d|credit.creditBureau.creditData[11].creditEndDateFact|14.11.2019 00:00:00
n|credit.creditBureau.creditData[11].creditJoint|1
...
n|credit.creditBureau.creditData[11].creditSum|88200
n|credit.creditBureau.creditData[11].creditSumDebt|0
n|credit.creditBureau.creditData[11].creditSumLimit|0
n|credit.creditBureau.creditData[11].creditSumOverdue|0
n|credit.creditBureau.creditData[11].creditSumType|1
n|credit.creditBureau.creditData[11].creditType|5
c|credit.creditBureau.creditData[11].creditTypeUni|5
d|credit.creditBureau.creditData[11].creditUpdate|20.02.2020 00:00:00
n|credit.creditBureau.creditData[11].cuid|44003648
...
c|credit.creditBureau.creditData[12].cbOverdueLine|CCCCC000000000000000000000000000-0000000000000000-
...
n|credit.creditBureau.creditData[12].creditCostRate|36.5
c|credit.creditBureau.creditData[12].creditCurrency|rur
d|credit.creditBureau.creditData[12].creditDate|31.03.2016 00:00:00
n|credit.creditBureau.creditData[12].creditDayOverdue|0
d|credit.creditBureau.creditData[12].creditEndDate|31.03.2022 00:00:00
d|credit.creditBureau.creditData[12].creditEndDateFact|17.12.2019 00:00:00
n|credit.creditBureau.creditData[12].creditJoint|1
...
n|credit.creditBureau.creditData[12].creditSum|0
...
n|credit.creditBureau.creditData[12].creditType|4
c|credit.creditBureau.creditData[12].creditTypeUni|4
d|credit.creditBureau.creditData[12].creditUpdate|22.12.2019 00:00:00
n|credit.creditBureau.creditData[12].cuid|44003648
...
c|credit.creditBureau.creditData[13].cbOverdueLine|CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC--0000-00-00000-
c|credit.creditBureau.creditData[13].contractSource|vki
n|credit.creditBureau.creditData[13].creditActive|0
c|credit.creditBureau.creditData[13].creditCurrency|rur
d|credit.creditBureau.creditData[13].creditDate|28.12.2013 00:00:00
n|credit.creditBureau.creditData[13].creditDayOverdue|0
d|credit.creditBureau.creditData[13].creditEndDate|02.03.2015 00:00:00
d|credit.creditBureau.creditData[13].creditEndDateFact|03.03.2015 00:00:00
n|credit.creditBureau.creditData[13].creditJoint|1
c|credit.creditBureau.creditData[13].creditOwner|0
n|credit.creditBureau.creditData[13].creditSum|22500
...
d|credit.creditBureau.creditData[13].creditUpdate|06.03.2015 00:00:00
n|credit.creditBureau.creditData[13].cuid|44003648
...
n|credit.creditBureau.creditData[14].cbAnnuity|0
c|credit.creditBureau.creditData[14].cbOverdueLine|CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC000000000
c|credit.creditBureau.creditData[14].contractSource|vki
n|credit.creditBureau.creditData[14].creditActive|0
c|credit.creditBureau.creditData[14].creditCurrency|rur
d|credit.creditBureau.creditData[14].creditDate|20.10.2013 00:00:00
n|credit.creditBureau.creditData[14].creditDayOverdue|0
d|credit.creditBureau.creditData[14].creditEndDate|20.06.2014 00:00:00
d|credit.creditBureau.creditData[14].creditEndDateFact|01.06.2014 00:00:00
n|credit.creditBureau.creditData[14].creditJoint|1
c|credit.creditBureau.creditData[14].creditOwner|0
n|credit.creditBureau.creditData[14].creditSum|30332
...
d|credit.creditBureau.creditData[14].creditUpdate|03.07.2014 00:00:00
n|credit.creditBureau.creditData[14].cuid|44003648
...
n|idCredit|209915381
n|persons[0].activeRdOffer|1
c|persons[0].activeSalaryClient|0
n|persons[0].activeScOffer|1
d|persons[0].birth|07.08.1989 00:00:00
n|persons[0].childNum|0
c|persons[0].contactMobilePhone|9191111187
n|persons[0].cuid|44003648
c|persons[0].education|3
c|persons[0].email|INNA@MAIL.RU
d|persons[0].employment.employedFrom|01.09.2013 00:00:00
c|persons[0].employment.employerPhone|4741111197
c|persons[0].employment.name|ufms
c|persons[0].familyState|2
n|persons[0].fieldExperience|79
c|persons[0].ident|4211111119
c|persons[0].incomeType|a
n|persons[0].isFakeCuid|0
c|persons[0].isNewApplicant|current
n|persons[0].mainOccupationIncome|27000
c|persons[0].mobil|9192511987
c|persons[0].name1|5111
c|persons[0].name2|311111111
c|persons[0].nameMid|2111111
c|persons[0].occupation|teacher
c|persons[0].occupationSector|16
c|persons[0].personType|1
n|persons[0].personUndesirable|0
c|persons[0].phoneEmp|4741111197
c|persons[0].sex|z
n|sourceData.behaviourData.persons[0].FlagNoInstNoPmt36M|1
c|sourceData.behaviourData.persons[0].altContactType|Mother
n|sourceData.behaviourData.persons[0].amtDpd|0
n|sourceData.behaviourData.persons[0].amtDpd30Ever|0
n|sourceData.behaviourData.persons[0].amtFpd0|0
n|sourceData.behaviourData.persons[0].amtSpd0|0
n|sourceData.behaviourData.persons[0].amtTpd0|0
n|sourceData.behaviourData.persons[0].avgDaysBetweenApplications|0
n|sourceData.behaviourData.persons[0].avgDaysBetweenApplications24m|0
n|sourceData.behaviourData.persons[0].avgDpd03m|0
n|sourceData.behaviourData.persons[0].avgDpd30|0
n|sourceData.behaviourData.persons[0].avgDpdTol|0
n|sourceData.behaviourData.persons[0].avgRateLengthEP|1
c|sourceData.behaviourData.persons[0].clientType|Other
n|sourceData.behaviourData.persons[0].cntApplication|1
n|sourceData.behaviourData.persons[0].cntApplication24m|0
n|sourceData.behaviourData.persons[0].cntApproved|1
n|sourceData.behaviourData.persons[0].cntApproved24m|0
n|sourceData.behaviourData.persons[0].cntClosed|1
...
n|sourceData.behaviourData.persons[0].cntDpd0|0
n|sourceData.behaviourData.persons[0].cntDpd30Ever|0
n|sourceData.behaviourData.persons[0].cntGoodPos|1
n|sourceData.behaviourData.persons[0].cntInst12M|0
n|sourceData.behaviourData.persons[0].cntInst24M|0
n|sourceData.behaviourData.persons[0].cntInst6M|0
...
c|sourceData.behaviourData.persons[0].codeOnTriggers_CB|exp;nbk
c|sourceData.behaviourData.persons[0].codePaidOffAfterDpd|0
c|sourceData.behaviourData.persons[0].crmSegment|DORMANT
...
d|sourceData.behaviourData.persons[0].dateIdPublish|19.09.2013 00:00:00
d|sourceData.behaviourData.persons[0].dateLastFullApplication|11.10.2015 16:54:45
...
c|sourceData.behaviourData.persons[0].education|3
d|sourceData.behaviourData.persons[0].employment.employedFrom|01.09.2012 00:00:00
c|sourceData.behaviourData.persons[0].employmentAddress.region|48
d|sysdate|08.04.2020 12:35:14
